...
EVALOP = list(map(int, getenv("EVALOP", "7458584835").split()))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Vishnusoni14/RADHAXMUSIC")
