...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/MOON-CODES/MOONS")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/world_friend_chatting_zone")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/music_support4")
